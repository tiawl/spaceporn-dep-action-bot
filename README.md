...
A composite action triggered on daily CRON. It monitors extern and intern repositories of the [tiawl/spaceporn](https://github.com/tiawl/spaceporn) dependencies chain.
